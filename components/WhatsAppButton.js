...
export default function WhatsAppButton() {
  const whatsappUrl = 'https://wa.me/919160110888?text=Hello!%20I%20would%20like%20to%20know%20more%20about%20your%20wealth%20management%20services.';
  ...
  return (
    <div className="fixed bottom-20 right-6 z-50 flex items-center">
      ...
      >
        ...
        <span className="max-w-0 overflow-hidden group-hover:max-w-[150px] transition-all duration-300 ease-out whitespace-nowrap text-sm font-semibold tracking-wide">
          Chat with Us
        </span>
      </motion.a>
    </div>
